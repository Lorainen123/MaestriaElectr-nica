...
while True:
    ...
    S_1m = ((S1/m)*(5.0/1023))
   # S_1 = (15.7251)-(26.6996*S_1m) + (10.5603*S_1m*S_1m)-(0.96494*S_1m*S_1m*S_1m)
    S_1=-25.3+10*S_1m
    #S_1 =(S1/m)*(5.0/1023)
    S_2m=((S2/m)*(5.0/1023))
    S_2=-25.3+10*S_2m
   # S_2 = 119.10*674-134.196*S_2m + 47.386*S_2m*S_2m-5.14693*S_2m*S_2m*S_2m
    
    S_3m=((S3/m)*(5.0/1023))
    #S_3 = 119.674-134.196*S_3m + 47.386*S_3m*S_3m-5.14693*S_3m*S_3m*S_3m
    S_3=-25.3+10*S_3m
    S_4m=((S4/m)*(5.0/1023))
   # S_4 = 119.674-134.196*S_4m + 47.386*S_4m*S_4m-5.14693*S_4m*S_4m*S_4m
    S_4=-25.3+10*S_4m
    
    S_5m=((S5/m)*(5.0/1023))
    #S_5 = 119.674-134.196*S_5m + 47.386*S_5m*S_5m-5.14693*S_5m*S_5m*S_5m
    S_5=-25.3+10*S_5m
   # S_6 = (((S6/m)*(5.0/1023))
   # S_6----
